...
// This script generates the GitHub Actions definition for the "web" directory,
// web.yml, using the nunjucks templating engine and the template `web.yml.njk`
